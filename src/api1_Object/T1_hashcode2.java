...
public class T1_hashcode2 {
	public static void main(String[] args) {
		...
		if(s1 == s2) System.out.println("s1과 s2는 같습니다."); //주소 비교
		else System.out.println("s1과 s2는 다릅니다."); 
		System.out.println("");
		
		if(s1 == s3) System.out.println("s1과 s3는 같습니다."); //주소 비교
		else System.out.println("s1과 s3는 다릅니다."); 
		System.out.println("");
		
		if(s1 == s4) System.out.println("s1과 s4는 같습니다."); //주소 비교 - 새로 생성 -> 같지 않다.
		else System.out.println("s1과 s4는 다릅니다."); 
		System.out.println("");
		
		if(s4 == s5) System.out.println("s4과 s5는 같습니다."); //주소 비교 - 새로 생성 -> 같지 않다.
		...
		System.out.println("11(hashCode)=> s1 : " + s1.hashCode() + ", s2 : " + s2.hashCode()); //같다
		System.out.println("12(hashCode)=> s1 : " + s1.hashCode() + ", s3 : " + s3.hashCode()); //다르다
