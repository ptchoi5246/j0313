...
// 문자열 정규식 // '?'는 0번이나 1번 '+'는 1번 이상 '*'는 0번 이상 //?+* 대신에 {3, :글자 이상 12, :글자 이하}길이
//\\w 영문 대소문자 / 숫자 /밑줄_/ 허용
public class Test5 {
	public static void main(String[] args) {
		...
		String regEx5 = "^[a-zA-Z0-9_-]{3,12}@[a-zA-Z0-9]+\\.[a-z]+(\\.[a-z])*$"; //사용 안됨
		String regEx6 = "^[a-zA-Z0-9_-]{3,12}@[a-zA-Z0-9]+(\\.[a-z]+)+$"; //정답
		String regEx7 = "\\w+@\\w+\\.\\w+"; //\\w 영문 대소문자 / 숫자 /밑줄_/ 허용
		String regEx8 = "\\w+@[a-zA-Z0-9]+\\.[a-z]+"; //\\w 영문 대소문자 / 숫자 /밑줄_/ 허용
		String regEx9 = "\\w{3,}@[a-zA-Z0-9]{1,8}\\.[a-z]{1,4}+"; //\\w 영문 대소문자 / 숫자 /밑줄_/ 허용
		...
		String str15 = "atom@naver.comasdf";
