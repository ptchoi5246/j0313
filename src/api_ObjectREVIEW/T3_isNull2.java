...
public class T3_isNull2 {
	public static void main(String[] args) {
		...
		else System.out.println("3. vo는 null이 아닙니다."); //출력
		System.out.println();
		//메소드 비교
		
		if(Objects.nonNull(vo)) System.out.println("4. vo는 null 아닙니다."); //출력
		else System.out.println("4. vo는 null입니다..");
		System.out.println();
		
		vo.setName("홍길동");		
		if(Objects.nonNull(vo.getName())) {
			System.out.println("5. name : " + vo.getName()); //홍길동
			if(vo.getName().equals("홍길동")) System.out.println("관리자"); //관리자
