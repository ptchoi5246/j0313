...
public class Test1 {
	public static void main(String[] args) {
		...
		Integer objSu1 = new Integer (intSu1); //중간 밑줄 : 요즘은 이렇게 사용 안 한다.
		System.out.println("2.objSu1 + 100 : " + (objSu1 + 100)); //참조타입(객체)로 변환해도 원래의 성격을 가지고 있다.
		
		//자동 박싱(Auto Boxint) 처리 예 )
		Integer objSu2;
		objSu2 = intSu1;
		System.out.println("3.objSu2 + 100 : " + (objSu2 + 100)); //참조타입(객체)로 변환해도 원래의 성격을 가지고 있다.
		System.out.println();
